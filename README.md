<div align="center">
  <img src="./assets/zaitsv-profile-rabbit.svg" alt="Никита Зайцев — DevOps, Web и AI-системы" width="100%" />
...
Мой главный принцип: **один раз сделать — и дальше система работает сама**. Клиент не должен постоянно платить за ручные деплои, обновления и тушение одних и тех же сбоев. Поэтому я сразу закладываю автоматизацию, мониторинг, безопасные обновления и восстановление.
